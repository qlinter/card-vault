...
当前版本 v1.3.3，纳入 DeepSeek、页面改进和架构整理；经用户确认，Windows x64 未签名安装包与便携包已于 2026-09-11 生成，源码、包内运行及产物验证通过，尚未上传发布。范围及验收统一见 [v1.3.3 发布说明](./release-v1.3.3.md)。v1.3.2 的既有产物与验证事实保留在历史文档中。
