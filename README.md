...
- 确认 `.env` 不要提交
- 确认 `node_modules`、`.next`、`dist` 不要提交
- 确认本地数据库文件不要提交
- 如果仓库面向公开展示，可以补充项目截图

当前 `.gitignore` 已经忽略了大部分本地构建产物和数据库文件。

## 说明

这是一个偏本地使用场景的项目，桌面端和本地数据目录的逻辑比普通 Web 项目更多。如果你后续要把它公开到 GitHub，建议同时保留本 README 和数据备份说明，方便别人理解项目定位。
