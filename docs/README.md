...
当前源码 v1.3.1；安装包与便携包已经用户确认后生成并验证，尚未上传。版本范围、代码优化及本批验收统一见 [v1.3.1 发布说明](./release-v1.3.1.md)，旧产物事实保留在各版发布文档。

## 入口与规划

- [中文 README](../README.md) / [English README](../README.en.md)：功能、启动、最新版本详细更新和全部历史版本摘要。
- [v1.3.1 发布说明](./release-v1.3.1.md)：当前修复、代码优化、格式边界、性能与发布验收。
