...
源码版本：`1.3.1`（2026-09-08）。本版汇总启动与可靠性修复、当前格式清理和代码优化；源码验收结果统一见 [v1.3.1 发布说明](./docs/release-v1.3.1.md)。**经用户确认，已于 2026-09-08 生成并验证 Windows x64 安装包和便携包；产物保存在本机，尚未上传。**
