...
const entryQueueDirectoryName = "entry-queue";
...
function resolveThumbnailsDir(projectRoot = process.cwd(), env = process.env) {
  return path.join(resolveDataDir(projectRoot, env), thumbnailsDirectoryName);
}
...
function resolveEntryQueueDir(projectRoot = process.cwd(), env = process.env) {
  return path.join(resolveDataDir(projectRoot, env), entryQueueDirectoryName);
}
