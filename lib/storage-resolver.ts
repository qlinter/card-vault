...
import { resolveDataDir as resolveCoreDataDir, resolveDbPath as resolveCoreDbPath, resolveEntryQueueDir as resolveCoreEntryQueueDir, resolveShareBackgroundsDir as resolveCoreShareBackgroundsDir, resolveShareCoversDir as resolveCoreShareCoversDir, resolveThumbnailsDir as resolveCoreThumbnailsDir, resolveUploadsDir as resolveCoreUploadsDir } from "./storage-paths-core.js";
...
export function resolveThumbnailsDir(env: StorageEnv = process.env): string {
  return resolveCoreThumbnailsDir(process.cwd(), env);
}
